<main class="l-privacy">
	<div class="l-container">
		<h2 class="section-title">個人情報保護</h2>
		<div class="privacy">
			<p>VOMを運営する株式会社Wunderbar（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
			...
			<p>住所：東京都江東区有明三丁目7番11号 有明パークビル 20F<br>社名：株式会社Wunderbar（カブシキガイシャヴンダーバー）<br>Eメールアドレス：<a href="mailto:info@vom.world" target="_blank">info@vom.world</a></p>
		</div>
		</p>
	</div>
</main>